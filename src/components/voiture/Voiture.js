...
import { BASE_IMG } from '../../../src/Config';
import './Voiture.css';
            ...
            <>
                <div className="col-md-4">
                    <div className="card-body bg-light mb-3">
                        <h5 className="card-title couleur-text text-center">{value.nom_marque} {value.version}</h5>
                        <img 
                            src={`${BASE_IMG}/${value.photo_profil}`}
                            className="card-img-top img-voiture-style img-fluid tooltip-test"
                            title="Cliquez pour voir"
                            alt="Voiture"
                            data-toggle="modal"
                            data-target="#staticBackdrop" />
                            <h5 className="mt-2 card-title bg-couleur text-white text-center">{value.prix} fcfa</h5>
                    </div>
                </div>
                {/* Modal ici */}
